...
#define RUN3 //RUN1 RUN2 RUN3 RUN4 RUN5
...
int main() {
	Wordlist words(5);
	words.insert(0, "HARRY");
	cout << words.at(0) << endl;
	words.insert(-1, "POOTTER");
	...
	//cout << wordlist->list[0] << endl;
	//cout << wordlist->list[2] << endl;
	////Wordlist* words = wordlist;
	//wordlist->display();

	//const char* a = wordlist->at(5);
